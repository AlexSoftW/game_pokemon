...
router.get("/ultimo_capturado/:id_home", function (req, res) {
  ...
  //Mostra qual pokemon incial mais escolhidos(global)
  router.get("/listar_inicial_escolhido", function (req, res) {
   usuarioController.listar_inicial_escolhido(req, res);
});
